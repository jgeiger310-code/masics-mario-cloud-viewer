(() => {
  ...
  function getReturnTarget() {
    try {
      ...
      if (sessionStorage.getItem("masics_return_to_date_review") === "ocr") return "date-review-ocr-unresolved.html?auth=dropbox&v=20260720-ocr-unresolved-1";
      if (sessionStorage.getItem("masics_return_to_date_review") === "1") return "date-review.html?auth=dropbox&v=20260720-exact-1";
    } catch {}
    return "";
  }
  function tokenReady() {
