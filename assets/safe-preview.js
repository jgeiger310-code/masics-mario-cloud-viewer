(() => {
  ...
  const SCRIPT_BASE_URL = document.currentScript && document.currentScript.src ? document.currentScript.src : new URL("assets/safe-preview.js", location.href).href;
  const PDFJS_MODULE_URL = new URL(`vendor/pdf.mjs?v=${PDFJS_DIST_VERSION}`, SCRIPT_BASE_URL).href;
  const PDFJS_WORKER_URL = new URL(`vendor/pdf.worker.mjs?v=${PDFJS_DIST_VERSION}`, SCRIPT_BASE_URL).href;
